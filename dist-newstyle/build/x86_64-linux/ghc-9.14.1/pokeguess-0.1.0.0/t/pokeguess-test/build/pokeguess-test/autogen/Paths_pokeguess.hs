...
-- at runtime using the environment variable pokeguess_bindir.
...
-- environment variable pokeguess_libdir.
...
-- using the environment variable pokeguess_dynlibdir.
...
-- runtime using the environment variable pokeguess_datadir.
...
-- using the environment variable pokeguess_sysconfdir.
...
libdir     = "/home/gabriel/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3/pokeguess-0.1.0.0-inplace-pokeguess-test"
dynlibdir  = "/home/gabriel/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3"
datadir    = "/home/gabriel/.cabal/share/x86_64-linux-ghc-9.14.1-c6c3/pokeguess-0.1.0.0"
libexecdir = "/home/gabriel/.cabal/libexec/x86_64-linux-ghc-9.14.1-c6c3/pokeguess-0.1.0.0"
sysconfdir = "/home/gabriel/.cabal/etc"

getBinDir     = catchIO (getEnv "pokeguess_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "pokeguess_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "pokeguess_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "pokeguess_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "pokeguess_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "pokeguess_sysconfdir") (\_ -> return sysconfdir)
